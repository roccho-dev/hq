...
func main() {
	var (
		...
		accept     = flag.String("accept", "", "non-interactive: accept this buffer and optionally append it to --queue")
...
func appendOne(path string, d hq.CompileDraft) error {
	f, err := os.OpenFile(path, os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0o644)
	if err != nil {
		return err
	}
	defer f.Close()
	return (hq.QueueWriter{W: f}).Append(d)
}
