...
// and raw input remain in the immutable instruction stream and in dry-run plan
// output; the durable rejection contract identifies the one-based source line.
